...
| Event | Template | To | Record | Trigger | Event key | Repeat | Activity / audit | Wired |
|---|---|---|---|---|---|---|---|---|
| `guest_order_access_requested` | `guest_order_access` | customer | order | A guest requests a verification code on the guest order page. | `guest-access-{challengeId}` | suppressed | guest_order_access_codes | yes |
