...
/**
 * Rendered as a **tab of `/staff/emails`**, not as a page of its own.
 *
 * It was `/staff/emails/deliveries`, one menu click away from the templates it
 * exists to debug: you edited the wording of the shipping email in one place
 * and found out whether it had reached anybody in another. Two surfaces, one
 * question. The route still exists and redirects here, so every bookmark and
 * every link in the ledger keeps working.
 */
export function EmailDeliveryCenter() {
  return (
    ...
    <div className="staff-page">
      <div className="staff-section-head">
        <div className="min-w-0">
          <h2 className="staff-section-title">Delivery history</h2>
