...
export default async function LegacyProjectCategory({ params }: { params: Promise<{ slug: string }> }): Promise<never> {
  const { slug } = await params;
  permanentRedirect(`/projects/category/${encodeURIComponent(slug)}`);
}
