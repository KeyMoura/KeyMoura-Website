...
export async function POST(req: NextRequest) {
  try {
    ...
    const normalizedRole = actorRole === "mod" ? "moderator" : actorRole;
    const canRequest =
      normalizedRole === "admin" || normalizedRole === "moderator" || normalizedRole === "support";
    ...
    // Admins may apply permanent bans immediately.
    // Moderators must request an approval.
    ...
    await logAuditEvent({
      actorUserId: user.id,
      actorRole: normalizedRole === "support" ? "support" : "moderator",
