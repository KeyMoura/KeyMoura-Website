    ...
    <div className="content-hub text-sm text-brand-text">
        ...
        <div className="pt-2">
          ...
          >
            ...
            <input
              ...
              placeholder="Search threads… (e.g. bracket, anodizing, tolerance)"
            ...
            <div className="mt-2 flex flex-wrap items-center justify-between gap-2 text-[11px] text-brand-textMuted">
              <div>
                {hasActiveQuery ? (
                  ...
                  <>Tip: type a comma to add a chip (e.g. “bracket, anodizing, tolerance”)</>
                )}
              </div>
      ...
      {helpOpen ? (
        <SearchHelpDialog
          ...
          title="Search threads across the community"
          intro=" to rank threads by relevance. Nothing is filtered away — the closest matches simply move to the top."
