    ...
    <main className="mx-auto max-w-6xl px-4 py-10">
      <div className="mb-8 flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Link href="/shops" className="catalog-action-secondary rounded-full px-4 py-2 text-sm">Trusted shops</Link>
          <Link href="/orders" className="catalog-action-secondary rounded-full px-4 py-2 text-sm">My requests & orders</Link>
        </div>
      </div>
